...
class IndependentSource(SourceBase):
    ...
    def __init__(
        ...
        domains: Optional[
            Sequence[typing.Union[openmc.Cell, openmc.Material, openmc.Universe]]
        ] = None,
    ):
...
class SourceParticle:
    ...
    def __init__(
        self,
        r: typing.Iterable[float] = (0.0, 0.0, 0.0),
        u: typing.Iterable[float] = (0.0, 0.0, 1.0),
        E: float = 1.0e6,
        time: float = 0.0,
        wgt: float = 1.0,
        delayed_group: int = 0,
...
def write_source_file(
    source_particles: typing.Iterable[SourceParticle], filename: PathLike, **kwargs
):
